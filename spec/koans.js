...
describe('the JavaScript language', () => {
    describe('has different types and operators', () => {
        ...
        it('concatenate arrays - well, kind of', () => {
            const a = [1, 2, 3];
            const b = [4, 5, 6];
            const aSpreadToString = [...a].toString()
            const bSpreadToString = [...b].toString()
            expect(a + b).toEqual(aSpreadToString + bSpreadToString);
        });
    ...
    describe('considers functions as first class citizens', () => {
        ...
        it('may return arrays that contains functions and so on', () => {
            function example() {
                ...
                const myReturnFunction = (arg) => {
                    const myArr = ['x', 10 * arg, 'z']
                    return myArr
                }
                const myResult = [myReturnFunction, 'x']
                return myResult
            }
