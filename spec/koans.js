...
describe('the JavaScript language', () => {
  describe('has different types and operators', () => {
    ...
    it('surprises me, NaN is not comparable with NaN', () => {
      expect(5 / 'a').toEqual(5 / 'a');     // But I thought (NaN == anything) is always false
  ...
  describe('considers functions as first class citizens', () => {
    ...
    it('matters, the declaration order when they are anonymous', () => {   // this is incorrect, it's because they are function expressions, not because they are anonymous
    ...
    it("doesn't have a private scope inside blocks", () => {
      let j = 0;
      for (var i = 0; i < 5; i++) {    // changed let to var to give it function scope
        j += i;
      }
  ...
  describe('has multiple ways to define and create objects', () => {
    ...
    it('may create objects also with the module pattern', () => {
      function createObject(initialScore, color) {
        ...
        return {
          ...
          incrementScoreIn: function(scoreIncrement) {
    ...
    it('can have have methods in the prototype', () => {
      function Obj() {
        const name = 'bob';
        this.name = name;     // necessary for prototype method to access name
      }
