...
describe("the JavaScript language", function() {
  ...
  describe("has different types and operators", function() {
    ...
    it("surprises me, NaN is not comparable with NaN", function() {
      ...
      expect(typeof(NaN)).toEqual(typeof(0));//preguntar
    ...
    it("considers zero to be falsy", function() {
      expect(0 == false).toBeTruthy();// Truthy or Falsy (0 es false y 1 es true)
      expect(0 === false).toBeFalsy();// Truthy or Falsy (0 es false y 1 es true)
    });
    ...
    it("considers nulls to be falsy", function() {
      ...
      if (x) { //entra por el else porq el if compara una variable sea distinta de null, undefinded. Si es null o undefined va a pasar por el else
         result = true;
      } else {
         result = false;
      }
    ...
    it("has arrays and they can contain anything inside", function() {
      ...
      expect(arr[6]).toEqual(); //te devuelve la posición vacia?
    ...
    it("concatenate arrays - well, kind of", function() {
      ...
      expect(a + b).toEqual(a + b); //revisar porq te devuelve la suma de los arrays sueltas
    });
    ...
    it("joins arrays and strings", function() {
      ...
      expect(a + "1").toEqual('1,2,31'); //saber si es como valor final o dinamico
    });
