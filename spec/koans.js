...
describe("the JavaScript language", function() {
  ...
  describe("has different types and operators", function() {
    ...
    it("has arrays and they can contain anything inside", function() {
      var arr = [1,2,3,4]; 
      arr.push(5);
      arr[9] = 6; // [1,2,3,4,5,undefined,undefined,undefined,undefinded,6]
  ...
  describe("considers functions as first class citizens", function() {
    ...
    it("may return arrays that contains functions and so on", function() {
      function example() {
         var arreglo =[function(arg){
           return arregloFuncion=[arg,arg*10]
         }]
         return arreglo
      }
    ...
    it("may return arrays that contains closures and so on", function() {
      function example() {
        var arregloExample = [function(arg){
          var arregloFuncion = [ arg, 9+arg]
          return arregloFuncion
        }]
        return arregloExample
      }
  ...
  describe("has multiple ways to define and create objects", function() {
    ...
    it("may create objects also with the module pattern", function() {
      function createObject(initialScore,inputColor) {
        return{
          incrementScoreIn: function(num){
            return initialScore+num
          },
          points: function(){
            var puntos = this.incrementScoreIn(5)
            return puntos
          },
         color: inputColor
        }
