...
describe("the JavaScript language", function() {
  ...
  describe("has multiple ways to define and create objects", function() {
    ...
    it("may create objects also with the module pattern", function() {
      function createObject(initialScore,selectedColor) {
          // write the code here
            var points = function(){return points}
            var incrementScoreIn = function(num){this.points += num}
            return {
              points: points,
              color: selectedColor,
