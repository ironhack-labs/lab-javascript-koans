...
describe('the JavaScript language', () => {
  describe('has different types and operators', () => {
    ...
    it('surprises me, NaN is not comparable with NaN', () => {
      ...
      expect(typeof(5 / 'a')).toEqual("number"); // I really don't understand why is the result "number" and also "NaN" truthy....
  ...
  describe('considers functions as first class citizens', () => {
    ...
    it('may return arrays that contains functions and so on', () => {
      function example() {
        return arr = [function blabla(num) {
          let arr2 = [];
          arr2.push(num);
          arr2.push(num * 10);
          return arr2;
    ...
    // I don't know how to tell it should be an error yet, but will look for it
