...
describe("the JavaScript language", function() {
  ...
  describe("has different types and operators", function() {
   ...
   it("has arrays and they can contain anything inside", function() {
    ...
    xit("concatenate arrays - well, kind of", function() {
      var a = [1,2,3];
      var b = [4,5,6];

      expect(a + b).toEqual([5,7,9]);
    });
  ...
  describe("considers functions as first class citizens", function() {
    ...
    xit("may return arrays that contains functions and so on", function() {
      function example() {
    ...
    xit("matters, the declaration order when they are anonymous", function() {
    ...
    xit("may return arrays that contains closures and so on", function() {
      function example() {
  ...
  describe("has multiple ways to define and create objects", function() {
    ...
    xit("may create objects also with the module pattern", function() {
