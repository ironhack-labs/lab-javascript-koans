...
describe("the JavaScript language", function() {
  ...
  describe("considers functions as first class citizens", function() {
    ...
    it("can declare anonymous functions", function() {
      ...
      expect(typeof(someVar)).not.toBe(undefined);
    ...
    it("may return arrays that contains functions and so on", function() {
      // function example() {
      //     var array = [function(num){num * array[1]; }, 10];
      //
      //       return array;
      // }

      // expect(example()[0](1)[1]).toEqual(10);    //index position 0, passing it the number one, then choosing index position 1.
    });
