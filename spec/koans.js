...
describe('the JavaScript language', () => {
  ...
  describe('considers functions as first class citizens', () => {
    ...
    it('matters, the declaration order when they are anonymous', () => {
      const exampleB = function(arg1) { //Hemos cambiado el orden del exampleB()
        return arg1;
      };
    ...
    it('can create closures with several free variables', () => {
      function external() {
        ...
        return internal() //hemos añadido return
      }
    ...
    it("doesn't have a private scope inside blocks", () => { //esto lo hemos cambiado
      let j = 0;
      let i = 10;
      function example () {
        let i
