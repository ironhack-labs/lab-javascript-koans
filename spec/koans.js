...
describe("the JavaScript language", function() {
  ...
  describe("considers functions as first class citizens:", function() {
    ...
    it("matters about the declaration order when they are anonymous", function() {
  ...
  describe("has multiple ways to define and create objects:", function() {
    ...
    it("may define complex objects", function() {
      var user;
      // write the contents of the obj to satisfy the expectations:
      user = {
        address: {
          street: 'sesame'
        },
      ...
      function createObject(initialScore, color) {
        ...
        return {
          ...
          incrementScoreIn: function(score) {
            return points = this.initialScore + score;
          },
          points: function() {
            return points;
          }
