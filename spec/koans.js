...
describe("the JavaScript language", function() {
  ...
  describe("has different types and operators", function() {
    ...
    it("knows the type of a function", function() {
      ...
      expect(typeof(xxx)).toBeTruthy('undefined');
    });
    ...
    it("has arrays and they can contain anything inside", function() {
      ...
      has different types and operators
      ...
      SPEC HAS NO EXPECTATIONS considers zero to be falsy
      SPEC HAS NO EXPECTATIONS considers nulls to be falsy
      knows the type of a function
      SPEC HAS NO EXPECTATIONS has arrays and they can contain anything inside
      SPEC HAS NO EXPECTATIONS may contain functions inside arrays
      SPEC HAS NO EXPECTATIONS concatenate arrays - well, kind of
      SPEC HAS NO EXPECTATIONS joins arrays and strings
      SPEC HAS NO EXPECTATIONS joins arrays and other things
      SPEC HAS NO EXPECTATIONS can't compare arrays*/
      arr[9] = 6;
  ...
  describe("considers functions as first class citizens", function() {
    ...
    it("may return arrays that contains functions and so on", function() {
      ...
      //expect(example()[0](1)[1]).toEqual(10); //el resultado es un arreglo que da 10 es un arreglo cuyo elemento es una funcion q toma un valor numerico como parametro y el resyulatado es un arreglo cuyo resultado es 10
    });
    ...
    it("passes objects by reference", function() {
      ...
      example(x);
      expect(x).toEqual({property: "cool!",property:"test"});
    });
  ...
  function createObject(initialScore, col) {
        ...
        color = col;
        return {
          incrementScoreIn: function(plus){ score+=plus; },
    ...
    it("can have have methods in the prototype", function() {
      ...
      var obj = new Obj();
      expect(obj.theName()).toEqual("undefine");
