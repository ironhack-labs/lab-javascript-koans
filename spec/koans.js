...
describe("the JavaScript language", function() {
  ...
  describe("has multiple ways to define and create objects", function() {
    ...
    it("may create objects also with the module pattern", function() {
      function createObject(initialScore, arg) {
        this.initialScore = initialScore;
        this.color = arg;
        this.incrementScoreIn = function(initialScore){return this.initialScore + initialScore}

        return {
          points: function(){return this.incrementScoreIn(5); },
        };
      }
