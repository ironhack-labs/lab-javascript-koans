...
describe('the JavaScript language', () => {
  ...
  describe('considers functions as first class citizens', () => {
    ...
    it("doesn't have a private scope inside blocks", () => {
      ...
      //expect(i).toEqual(0); //If use let inside for.
      expect(i).toEqual(5);
      expect(j).toEqual(10);
    });
  });
  ...
  describe('has multiple ways to define and create objects', () => {
    ...
    it('may define complex objects', () => {
      ...
      expect(user.friends[1].surname).toEqual('traka');//bonusTrack
    });
    ...
    it('may create objects also with the module pattern', () => {
      ...
      const incFive = obj.incrementScoreIn(5);
    ...
    it('can have have methods in the prototype', () => {
      ...
      const obj = new Obj();
      expect(obj.theName()).toEqual(obj.name);
    ...
    it('can define a factory', () => {
      ...
      const instance = obj();
      expect(instance.theName()).toBe(obj().theName());
      //expect(instance.theName()).toBe('bob');    Another road to do 544 expect
    ...
    describe('the polymorphism', () => {
      it('may use constructor plus prototype', () => {
        ...
        expect(child.someMethod()).toEqual(Parent.prototype.someMethod()); //10
