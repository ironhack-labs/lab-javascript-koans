...
describe("the JavaScript language", function() {
  describe("has different types and operators", function() {
    ...
    it("considers zero to be falsy", function() {
      //DONE ----- expect(0 == false).toBe......();// Truthy or Falsy
      //DONE ----- expect(0 === false).toBe.....();// Truthy or Falsy
    ...
    it("considers nulls to be falsy", function() {
      ...
      //DONE TRICK ??? ----- expect(result == false).toBe......();// Truthy or Falsy
      //DONE ----- expect(null === false).toBe.....();// Truthy or Falsy
      //DONE ----- expect(null == false).toBe....();// Truthy or Falsy
    ...
    it("concatenate arrays - well, kind of", function() {
      ...
      //DONE ---- expect(a + b).toEqual();
      //Treat the arrays values as strings when added/joined together
    ...
    it("joins arrays and strings", function() {
      ...
      //DONE ---- expect ("1" + a).toEqual();
      //DONE ---- expect(a + "1").toEqual();
    ...
    it("joins arrays and other things", function() {
      ...
      //DONE ---- expect(1 + a).toEqual();
      //DONE ---- expect(a + 1).toEqual();
      //DONE ---- expect(1 + b).toEqual();
      //DONE ---- expect(true + a).toEqual();
      // When two types are differents, it treat them as strings
    ...
    it("can't compare arrays", function() {
      ...
      //DONE ---- expect(a == b).toBe.....();  // Truthy or Falsy
      //DONE ---- expect(a === b).toBe.....(); // Truthy or Falsy
      //Cannot compare array if we dont precise any index
  ...
  describe("considers functions as first class citizens", function() {
    ...
    it("can declare anonymous functions", function() {
      ...
      // expect(typeof someVar).toBe("a+b");
      // expect(someVar(1, 1)).toBe();
    });
    ...
    it("may return arrays that contains functions and so on", function() {
      ...
      // function written above to get the expect (already given)
      // DONE BUT TODO AGAIN -----------------------------
