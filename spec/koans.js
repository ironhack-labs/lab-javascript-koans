...
//ReferenceError: Cannot access uninitialized variable. in http://127.0.0.1:5500/spec/koans.js (line 211)
    ...
    it("doesn't have a private scope inside blocks", () => {
      ...
      expect(i).toEqual(3); //no entiendo bien el por qué va un 3
      expect(j).toEqual(10);
    });
  });
