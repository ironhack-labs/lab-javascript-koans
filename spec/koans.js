...
describe("the JavaScript language", function() {
  ...
  describe("has different types and operators", function() {
    ...
    it("has arrays and they can contain anything inside", function() {
      ...
      expect(arr[6]).not.toEqual("undefined");
      expect(arr[9]).toEqual(6);
      expect(matrix[0][2]).toEqual('c'); //matrix est un tableau à 2 dimensions donc prendre index 0 du premier tableau et l'index 2 de ce dernier
    ...
    it("concatenate arrays - well, kind of", function() {
      ...
      expect(a + b).toEqual("1,2,34,5,6"); //qd addition 2 tableaux (array) c'est transformé en string puis les 2 sont collés
    });
