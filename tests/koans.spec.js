describe('the JavaScript language', () => {
  describe('has different types and operators', () => {
    ...
    it('is not the same to compare by value than by reference ', () => {
      const a = [1, 2, 3]; // a=@98472395 la direccion donde encontramos el array
      const b = [1, 2, 3]; // b=@80000000

      // let a=2 esta creando un espacio (@123) donde pone el valor a

      // let b=2 aha! ya tenemos 2 en la dir @123 y por eso b=@123 igual que a
